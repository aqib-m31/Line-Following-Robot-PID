/*
  LineFollowingRobotPID.ino
  An autonomous line-following robot using five IR sensors and PID control for smooth, stable line tracking. The robot follows a black line on a white surface with minimal oscillation and flickering compared to bang-bang control.
*/
#include "TRSensors.h"
...
void loop() {
  ...
  // Compute PID Output
  int power_difference = proportional / 5 + integral / 10000 + derivative * 30;
